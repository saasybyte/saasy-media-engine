...
int main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) {
  ...
  saasy::listening_engine::ListeningEngineServiceImpl service;

  std::string uds_address = "unix:///tmp/listening-engine.sock";
  ...
  std::cout << "[Main] Listening Engine listening on " << uds_address << "\n";
